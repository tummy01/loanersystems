    ...
    <div class="row">   
        ...
        <div class="span9">
            ...
            <div class="alert alert-info">
                ...
                <strong><i class="icon-tasks icon-large"></i>&nbsp;RePayment Form</strong>
            </div>
             ...
             WHERE (loanapplication.status = '1')
                    ...
                    while ($row = mysqli_fetch_array($query)) {
                        ...
                        <tr class="del<?php echo $id ?>">
                            ...
                            <td><div class="well-small"><?php echo $row['repay_status']; ?></div></td>
                             <td><div class="well-small"><?php echo $row['repayDate']; ?></div></td>
